          ...
          <header className="border-b border-neutral-100">
            <div className="mx-auto max-w-5xl px-4 py-3 flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <a href="https://wa.me/+919623959623" target="_blank" rel="noopener noreferrer" className="flex items-center px-4 py-2 rounded-full border border-neutral-300 text-black text-sm font-medium hover:bg-green-50 hover:border-green-400 transition-colors">
