                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <SimpleDatePicker
                      ...
                      highlight={segment.origin && segment.destination && !segment.departureDate}
                    />
                  </div>
                </div>
              </div>
...
const SimpleDatePicker = ({ value, onChange, minDate, label, className, onRangeSelect, enableRangeChips = false, highlight = false, buttonRef = null }) => {
  ...
  return (
    <div className="relative date-picker-compact" ref={calendarRef}>
      ...
      {showCalendar && (
        <div className="absolute top-full left-0 right-0 z-50 mt-2 bg-white border border-blue-200 rounded-xl shadow-xl p-3 max-w-sm sm:max-w-md md:max-w-lg calendar-container">
          {/* Calendar Header */}
          <div className="flex items-center justify-between mb-2 date-picker-header">
            <button
              type="button"
    ...
    <div className="relative">
      ...
      <div className="relative">
        ...
        <input
          ...
          onBlur={handleBlur}
          className={`w-full pl-14 pr-4 py-4 text-lg border rounded-2xl transition-all duration-200 bg-white shadow-sm hover:shadow-md ${highlight ? 'border-blue-400 ring-2 ring-blue-200 animate-bounce-glow' : 'border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500'}`}
        />
