...
function App() {
  // Navigation state
  const [currentPage, setCurrentPage] = useState('results'); // 'search', 'results', 'selection', 'passenger', 'payment', 'confirmation' - TEMP: Set to 'results' to test header consistency
