...
const SimpleDatePicker = ({ value, onChange, minDate, highlight = false, inputRef = null, autoOpenToken = 0 }) => {
    ...
    <>
      ...
      {showMobileModify && (
        <div className="fixed inset-0 bg-black/50 z-50 md:hidden" role="dialog" aria-modal="true">
          <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl p-4 pb-24 max-h-[85vh] overflow-y-auto" id="mobileQuickPanel">
